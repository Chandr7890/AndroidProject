...
public class asmwt extends AppCompatActivity {
    Button btn ;
    TextView textView1;
    ...
    url ob = new url();
    String URL = "http://"+ob.url+"/PHP/asmwt.php";
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_asmwt);
...
//            }
            ...
            Toast.makeText(asmwt.this, "Invalid login", Toast.LENGTH_SHORT).show();
        }
    }
