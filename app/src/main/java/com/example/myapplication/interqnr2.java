...
public class interqnr2 extends AppCompatActivity {
    Button btn ;
    TextView textView1;
    TextView t1;
    TextView t2;
    ...
    url ob = new url();
    String URL = "http://"+ob.url+"/PHP/PESS.php";
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_interqnr2);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(interqnr2.this,ESS.class);
...
//            startActivity(intent);
            ...
            Toast.makeText(interqnr2.this, "Invalid login", Toast.LENGTH_SHORT).show();
        }
    }
