...
public class interqnr3 extends AppCompatActivity {
    Button btn ;
    TextView textView1;
    TextView t1;
    TextView t2;
    ...
    url ob = new url();
    String URL = "http://"+ob.url+"/PHP/pmmr.php";
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_interqnr3);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(interqnr3.this,mmr.class);
...
//            startActivity(intent);
           ...
           // processJSONData();
            ...
            Toast.makeText(interqnr3.this, "Invalid login", Toast.LENGTH_SHORT).show();
        }
    }
