...
public class interst extends AppCompatActivity {
    ...
    url ob = new url();
    String URL = "http://"+ob.url+"/PHP/interst.php";
       ...
       String value = intent1.getStringExtra("id");
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(interst.this,language.class);
...
//            startActivity(intent);
            ...
            Toast.makeText(interst.this, "Invalid login", Toast.LENGTH_SHORT).show();
        }
    }
