...
public class videos extends Activity {
        ...
        btnUploadVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectedVideoPath != null) {
                    ...
                    Toast.makeText(videos.this, "Please select a video first", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void uploadVideo(final String selectedPath) {
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    String serverURL = "http://"+ob.url+"/PHP/addVideos.php";
                    ...
                    if (serverResponseCode == 200) {
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(videos.this, "Video uploaded successfully", Toast.LENGTH_SHORT).show();
                            }
                        });
                    } else {
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(videos.this, "Failed to upload video", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
