...
public class stQustionnaire extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_st_qustionnaire);
    ...
    private void sendScoreToServer(final int score) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    Intent intent = new Intent(stQustionnaire.this,dashboard.class);
