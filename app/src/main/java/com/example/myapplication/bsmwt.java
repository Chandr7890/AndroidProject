...
public class bsmwt extends AppCompatActivity {
    Button btn ;
    TextView textView1;

    private BarChart barChart;
    private RequestQueue requestQueue;
    TextView editText1, editText2, editText3, editText4, editText5, editText6, editText7, editText8,editText9, editText10, editText11, editText12;
    url ob = new url();
    String URL = "http://"+ob.url+"/PHP/bsmwt.php";
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bsmwt);
...
//                Intent intent = new Intent(bsmwt.this,Qnr1.class);
...
//        });
    ...
    private void handleResponse(String response) {
        ...
        String q9 = jsonObject.get("s9").getAsString();
        String q10= jsonObject.get("s10").getAsString();
        String q11 = jsonObject.get("s11").getAsString();
        String q12= jsonObject.get("s12").getAsString();
...
//            }
            ...
            editText9.setText(q9);
            editText10.setText(q10);
            editText11.setText(q11);
            editText12.setText(q12);




        } else if ("failure".equals(status)) {
            Toast.makeText(bsmwt.this, "Invalid login", Toast.LENGTH_SHORT).show();
        }
    }
