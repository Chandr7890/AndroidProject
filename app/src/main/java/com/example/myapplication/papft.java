...
public class papft extends AppCompatActivity {
    Button btn ;
    TextView textView1;
    ...
    url ob = new url();
    String URL = "http://"+ob.url+"/PHP/ppopft.php";
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_papft);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(papft.this,Qnr1.class);
...
//            }
            ...
            Toast.makeText(papft.this, "Invalid login", Toast.LENGTH_SHORT).show();
        }
    }
