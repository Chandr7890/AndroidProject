...
public class Availableslots extends AppCompatActivity {
    ...
    url ob = new url();
    private String URL = "http://"+ob.url+"/PHP/bokking.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_availableslots);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!pid.isEmpty() && !name.isEmpty()) {
                    ...
                    Toast.makeText(Availableslots.this, "Fields cannot be empty", Toast.LENGTH_SHORT).show();
                }
    ...
    private void handleResponse(String response) {
        ...
        if ("success".equals(status)) {
            ...
            Intent intent2 = new Intent(Availableslots.this,Calender.class);
